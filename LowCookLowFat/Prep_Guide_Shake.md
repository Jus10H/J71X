...
- [ ] 1.5 cups organic unsweetened soy milk (360ml)
...
Add ingredients to the blender in this order for best results:
...
## Taken Separately (NOT Blended)

These go alongside the shake, not in it:
...
Rinse the blender immediately after pouring. If you wait, the oats and sorghum cement to the sides. A quick rinse + a drop of soap + a 10-second blend with water keeps it clean.
